(function ($) {
  ...
  $(document).on("click", "#toggle_btn", function () {
    if ($("#toggle_btn").children().hasClass("fa-align-justify")) {
      $("#toggle_btn").children().removeClass("fa-align-justify");
      $("#toggle_btn").children().addClass("fa-align-left");
    } else {
      $("#toggle_btn").children().removeClass("fa-align-left");
      $("#toggle_btn").children().addClass("fa-align-justify");
    }
